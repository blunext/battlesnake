...
func TestAll(t *testing.T) {
	...
	x, y, ok := play.FindFood(g.You.Head, board, g.Board.Food)
	assert.Truef(t, ok, "nie ok")
	best := play.FindCoordinates(x, y, g.You.Head)
	fmt.Println("path ", best.Heading)

	//moves := play.RankSpace(g.You.Head, board)
